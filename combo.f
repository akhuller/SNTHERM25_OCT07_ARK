...
c  DENSITY.  TUESDAY version
c***********************************************************************
      subroutine combo(dz,dz2,t,t2,bw,bw2,dmass,dmass2,bbo,bbo2,dlm,ci,
     1 tl,dice,a1,dsolo,dsolo2,flo,do,do2,H2Olayer,icalcstep,iunit)!REJ 6/24/24+6/29/25
...
c bwc: Combined nodal water constituents bulk density of nodes 1 and 2 [kg/m^3] !Recheck this
...
cREJ_2025 There was no significant diff betwn these.  check out why not.
c      if(icalcstep .gt. 8000)stop 'combo 8000'     
      bbo=bbo+bbo2
      dsolo=dsolo+dsolo2
      do=(do*dmass+do2*dmass2)/dmassc
c      Test mass balance
c      write(*,*)'dz',dz,dz2,dzc
c      write(*,*)'mass',dmass,dmass2,dmassc,dmass+dmass2
c      write(*,*)'bwc',bwc,'dc_test',dmassc/bwc
c      stop 'combo'
c
c Nov 2
